...
It adds a new `user_login` action to the CKAN API so that you can call it for authentication of a user from a third party application. The identifier can be either a CKAN username or the user's email:
